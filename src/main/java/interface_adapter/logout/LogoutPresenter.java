...
public class LogoutPresenter implements LogoutOutputBoundary {
    ...
    public void prepareSuccessView(LogoutOutputData response) {
        ...
        final LoggedInState loggedIn = loggedInViewModel.getState();
        loggedIn.setUsername("");
        loggedInViewModel.setState(loggedIn);
        ...
        final LoginState logIn = loginViewModel.getState();
        logIn.setUsername("");
        logIn.setPassword("");
        loginViewModel.setState(logIn);
